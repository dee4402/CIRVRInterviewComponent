...
namespace Cirvr.ConversationManager
{
    public class TextToSpeech : MonoBehaviour
    {
        ...
        "This is another test of audio file 2",
        "And here is a final test for you.",
    };
        ...
        void Update()
        {
            if (token != null)
            {
                UnityEngine.Debug.Log(questionsList[0]);
                StartCoroutine(GetAudioFilePostRequest(questionsList[0]));
                token = null;
            }
        }
